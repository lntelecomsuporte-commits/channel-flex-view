    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Cole esta URL no campo <strong>url</strong> do Hubsoft. A autenticação já vai embutida no caminho.
          </CardDescription>
        </CardHeader>
        <CardContent>
          ...
          <div className="mt-4 p-4 bg-muted/50 rounded-lg text-sm text-muted-foreground space-y-2">
            ...
            <ol className="list-decimal list-inside space-y-1">
              ...
              <li>Cole a <strong>Callback URL</strong> acima no parâmetro <strong>url</strong></li>
